			...
			for (int ip = 0; ip < m_Streams.Count; )
			{
                ...
                else if (sub)
                {
                    ...
                    if ((null == subInfos) || (subInfos.Length < 1))
                    {
                        ...
                        subDescr.Subtitles.Add(new SubtitleInfo("deu", SubtitleTypes.DVBNormal, 1, 1));
                    }
                    else
                    {
                        // Use as is
                ...
                else if (aud)
                {
                    ...
                    audioDescriptor.Languages.Add(new LanguageItem(language, ac3 ? AudioTypes.Undefined : AudioTypes.CleanEffects));
