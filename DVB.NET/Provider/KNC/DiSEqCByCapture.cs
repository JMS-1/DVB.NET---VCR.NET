...
namespace JMS.DVB.Provider.KNC
{
    /// <summary>
    /// Implementiert die de facto Standardansteuerung für DiSEqC über den <see cref="IBDAFrequencyFilter"/>.
    /// </summary>
    [
        Pipeline( PipelineTypes.DiSEqC, "Using FrequencyFilter / InputRange on Capture Filter (exotic)" )
    ]
    public class DiSEqCByCapture : IPipelineExtension
    {
        /// <summary>
        /// Erzeugt eine neue Implementierung.
        /// </summary>
        public DiSEqCByCapture()
        {
        }
