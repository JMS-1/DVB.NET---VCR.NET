...
{
    /// <summary>
    /// Signalinformationen für die Hauppauge Nova-HD-S2 bereitstellen.
    /// </summary>
    [
        Pipeline( PipelineTypes.SignalInformation, "Hauppauge Nova-HD-S2" ),
    ]
    public class NovaHDS2Signal : IPipelineExtension
    {
        /// <summary>
        /// Initialisiert die Instanz des Providers.
        /// </summary>
        public NovaHDS2Signal()
        {
        }
