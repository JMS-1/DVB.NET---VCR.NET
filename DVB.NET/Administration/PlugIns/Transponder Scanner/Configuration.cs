...
{
    /// <summary>
    /// Über diese Erweiterung werden die Ursprünge für die Aktualisierung der
    /// Quellen in einem Profil festgelegt.
    /// </summary>
    public class Configuration : PlugInWithProfile
    {
        /// <summary>
        ...
        public override string DisplayName
        {
            ...
            {
                // Report
                return Properties.Resources.Location_Name;
            }
        }
        ...
        public override string ShortName
        {
            ...
            {
                // Report
                return Properties.Resources.Location_ShortName;
            }
        }
        ...
        {
            // Just create
            return new ConfigurationDialog( this, site );
        }
