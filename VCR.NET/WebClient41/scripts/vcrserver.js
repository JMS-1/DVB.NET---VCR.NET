...
(function (VCRServer) {
    ...
    function updateConfiguration(type, contract, protocolFilter) {
        if (protocolFilter === void 0) { protocolFilter = null; }
        if (protocolFilter == null)
            protocolFilter = function (key, value) { return value; };
        return $.ajax({
        ...
        SourceEntryCollection.prototype.requestSources = function (profileName, whenDone) {
            ...
            if (this.getSourcesForProfile(profileName) != undefined)
                ...
                getProfileSources(profileName).done(function (data) {
                    _this.profileSources[profileName] = $.map(data, function (rawData) { return new SourceEntry(rawData); });
                    whenDone();
                });
        };
    ...
    var UserProfile = (function () {
        ...
        UserProfile.prototype.refresh = function () {
            var _this = this;
            this.isLoaded = false;
            getUserProfile().done(function (data) { return _this.loadFrom(data); });
        };
        ...
        UserProfile.prototype.loadFrom = function (data) {
            ...
            this.recentSources = {};
            $.each(data.recentSources, function (index, sourceName) { return _this.recentSources[sourceName] = true; });
