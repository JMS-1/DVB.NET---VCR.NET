...
class adminPage extends Page implements IPage {
    ...
    onInitialize(): void {
        ...
        VCRServer
            ...
            .then(data => { this.devices = data; return JMSLib.TemplateLoader.load('adminDevices'); })
            .then<any>((data: VCRServer.GuideSettingsContract) => { this.guide = data; return VCRServer.getSourceScanSettings(); })
            .then<any>((data: VCRServer.SourceScanSettingsContract) => { this.scan = data; return VCRServer.getGuideSettings(); })
