...
namespace VCRNETClient.App.Admin {
    ...
    export class OtherSection extends Section implements IAdminOtherPage {
        ...
        // Die Art des automatischen Schlafzustands.
        readonly hibernation = new JMSLib.App.SelectSingleFromList(this, "hibernationMode", "Art des von VCR.NET ausgelösten Schlafzustands", null, OtherSection._hibernation);

        // Die Art der Protokollierung.
        readonly logging = new JMSLib.App.SelectSingleFromList({}, "logging", "Umfang der Protokollierung in das Windows Ereignisprotokoll", null, OtherSection._logging);
