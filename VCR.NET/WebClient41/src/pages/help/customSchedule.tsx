        ...
        render(page: App.IPage): JSX.Element {
            return <div>
                ...
                <div>
                    ...
                    nächst niedrigeren und so weiter - für die andere Reihenfolge kann die Ordnung
                    ...
                    rein willkürliche Entscheidung. In Kombination mit <i>ByPriority:Descending</i>
                    bedeutet dies, dass zuerst einmal das Gerät mit der höchsten Aufzeichnungspriorität
                    untersucht wird. Eine Zuordnung ist besser als eine andere, wenn auf diesem Gerät
                    mehr Aufzeichnungen stattfinden - durch die Position im Regelwerk wird dieser Vergleich
