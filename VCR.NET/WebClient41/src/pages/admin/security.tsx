    ...
    export class AdminSecurity extends JMSLib.ReactUi.Component<App.IAdminSecurityPage>{
        render(): JSX.Element {
            return <div className="vcrnet-admin-security">
                ...
                {this.getHelp()}
                <Field label={this.props.noui.userGroups.text} page={this.props.noui} >
                    <JMSLib.ReactUi.EditTextWithList noui={this.props.noui.userGroups} />
                </Field>
                <Field label={this.props.noui.adminGroups.text} page={this.props.noui} >
                    <JMSLib.ReactUi.EditTextWithList noui={this.props.noui.adminGroups} />
                </Field>
                <JMSLib.ReactUi.ButtonCommand noui={this.props.noui.saveSecurity} />
            </div>;
        }
