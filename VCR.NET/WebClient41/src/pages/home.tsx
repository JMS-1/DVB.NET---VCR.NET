        ...
        render(): JSX.Element {
            return <div>
                <div>
                    ...
                    <ul>
                        <li><InternalLink pict="plan" view="plan">dem Aufzeichnungsplan</InternalLink> mit den anstehenden Aufzeichnungen<HelpLink page={this.props.noui} topic="parallelrecording" /></li>
