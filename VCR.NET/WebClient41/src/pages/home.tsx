...
namespace VCRNETClient {
    ...
    export class Home extends JMSLib.ReactUi.Component<App.NoUi.HomePage>{
        render(): JSX.Element {
            ...
            return <div>
                <div>
                    ...
                    <ul>
                        <li><InternalLink pict="plan" view={application.planPage.route}>dem Aufzeichnungsplan</InternalLink> mit den anstehenden Aufzeichnungen<HelpLink page={this.props.noui} topic="parallelrecording" /></li>
                        ...
                        <li><InternalLink pict="new" view={application.editPage.route}>einer neuen Aufzeichnung</InternalLink></li>
                    </ul>
                    <ul>
                ...
                <div>
                    Weitere Informationen zum VCR.NET Recording Service findet man hier im Bereich der <InternalLink view={`${application.helpPage.route};overview`}>Fragen &amp; Antworten</InternalLink>, auf
