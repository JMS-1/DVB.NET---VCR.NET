...
namespace JMS.DVBVCR.RecordingService
{
    partial class VCRServer
    {
        ...
        public static void LogError( string format, params object[] args ) => Log( LoggingLevel.Errors, EventLogEntryType.Error, format, args );
        ...
        public static void Log( LoggingLevel level, string format, params object[] args ) => Log( level, EventLogEntryType.Information, format, args );
